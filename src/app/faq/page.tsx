...
export const metadata: Metadata = {
  ...
  keywords: ['박스제작 최소수량', '샘플 무료', '무료 샘플', '무료 구조샘플', '박스제작 납기', '박스제작 문의', '패키지 제작기간', '박스 무료샘플', '구조설계 샘플'],
};
...
const faqList = [
  ...
  },
  {
    ...
    answer: '양산 확정 시 선수금 20% 입금 후 생산을 시작하며, 납품 완료 후 잔금 80%를 납부하시면 됩니다.',
  },
];
