...
export const metadata: Metadata = {
  ...
  description: '드림박스는 맞춤 패키지 샘플 제작을 기반으로 새로운 형태의 박스를 제작합니다. 무료 샘플 확인 후 소량부터 대량까지 생산·납품까지 원스톱으로 진행합니다.',
  // 파비콘 설정 추가
  icons: {
    icon: [
  ...
  openGraph: {
    title: '싸바리박스 단상자 시딩박스 브랜드패키지 맞춤패키지 맞춤박스 제작 전문업체 드림박스 | 구조 샘플 무료',
    description: '구조 샘플 무료. 싸바리박스 단상자 시딩박스 베이커리박스 약상자 크라프트상자 맞춤패키지 맞춤박스 제작 전문 업체 드림박스입니다. 무료 샘플 컨펌 후 소량 제작 가능합니다.',
    url: SITE_URL,
