...
export const metadata: Metadata = {
  ...
  description: '드림박스가 진행한 시딩박스, 화장품박스, 베이커리박스, 약상자, 크라프트상자, 싸바리박스, 단상자, 커스텀박스, 쇼핑백, 종이쇼핑백, 인쇄물 등 다양한 패키지 제작사례를 확인해 보세요.',
  keywords: ['박스제작 사례', '패키지제작 사례', '베이커리박스', '약상자', '화장품박스', '크라프트상자', '선물포장박스', '종이쇼핑백', '커스텀박스제작', '쇼핑백제작', '인쇄물제작', '시딩박스 제작사례', '싸바리박스 제작사례', '단상자 제작사례'],
};
